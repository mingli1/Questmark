...
class CircularMovementSystem : EntitySystem() {
    ...
    private var targets: MutableMap<Entity, Vector2>? = null

    private var entities: ImmutableArray<Entity>? = null
    // map of entity to its rotation scheme (true for clockwise, false for counterclockwise)
    private var rotationDir: MutableMap<Entity, Boolean>? = null
    private var lastDir: MutableMap<Entity, Direction>? = null
